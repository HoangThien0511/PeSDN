...
const cors = require('./cors'); // Update to use the local cors module
...
dishRouter.route('/')
.options(cors.corsWithOptions, (req, res) => { res.sendStatus(200); }) // OPTIONS handler for preflight requests
